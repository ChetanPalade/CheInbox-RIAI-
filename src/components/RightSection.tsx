    ...
    <div className="border-l-2 bg-white dark:bg-black dark:border-[#33383F] border-[#E0E0E0] h-full overflow-y-scroll no-scrollbar px-2">
      ...
      <div className="px-6 my-10 space-y-6 dark:text-white text-[#637381]">
        <div className="flex justify-between text-sm">
          ...
          <div className="dark:text-[#B9B9B9]">Cheatan</div>
        </div>
        <div className="flex justify-between text-sm">
          <div>Contact No</div>
          <div className="dark:text-[#B9B9B9]">+91-906282XXXX</div>
        </div>
        <div className="flex justify-between text-sm">
          <div>Email ID</div>
          <div className="dark:text-[#B9B9B9]">cp19@gmail.com</div>
        </div>
        <div className="flex justify-between text-sm">
          <div>Linkedin</div>
          <div className="dark:text-[#B9B9B9]">linkedin.com/in/chtank/</div>
        </div>
        <div className="flex justify-between text-sm">
      ...
      <div className="my-8 px-4">
        ...
        <div className="px-2">
          <div className="flex my-4 items-center">
            <div>
              <img
                src={"https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRuWEWdpizM87tDxZYIEMdZ-trM-ploac1IMQ&s"}
            ...
            <div className="ml-10 space-y-2 text-black dark:text-white">
              ...
              <div className="text-[#B9B9B9] text-sm flex items-center ">
                {" "}
                <IoIosSend className="mr-2" /> Sent 23rd, Aug
              </div>
            </div>
          </div>
