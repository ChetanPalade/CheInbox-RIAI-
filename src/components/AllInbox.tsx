...
function AllInbox({
  ...
  async function reloadHandler() {
    ...
    await axios.get("https://hiring.reachinbox.xyz/api/v1/chebox/reset", {
      headers: {
        Authorization: token,
      },
    });
    ...
    >
      <div>
        <div className="flex justify-between">
          ...
          <div className="dark:text-[#FCFCFC66] text-[#919EAB] font-thin pr-3">23 August 2024</div>
        </div>
        <div className="py-2 dark:text-[#E1E0E0] text-gray-600 font-normal">
          {trimSubject(subject, 7)}
        </div>
        <div className="flex">
          <div className="dark:bg-[#222426] bg-[#b6a4a4] px-3 py-1 rounded-2xl text-[#c0bf83] text-sm flex items-center">
